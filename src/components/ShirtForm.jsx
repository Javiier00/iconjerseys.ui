        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
                ...
                <div className="space-y-4">
                    <div>
                        <label htmlFor="team_id" className="block text-sm font-medium text-yellow-700 mb-1">
                            Equipo *
                        </label>
                        <select
                            id="team_id"
                            ...
                            className="w-full px-3 py-2 border border-yellow-400 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400 bg-white text-black placeholder-yellow-400"
                            required
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 border border-yellow-400 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400 bg-white text-black placeholder-black-400"
                    ...
                    <div>
                        <label htmlFor="size" className="block text-sm font-medium text-yellow-700 mb-1">
                            Talla *
                        </label>
                        <input
                            type="text"
